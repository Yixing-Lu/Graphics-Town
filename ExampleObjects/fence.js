...
(function () {
    ...
    Fence = function Fence(name, position, size, sizex, sizey, sizez, color) {
        this.name = name;
            ...
            var arrays = {
                vpos: {
                    numComponents: 3, data: [
                        -.5, 0, -.5, .5, 0, -.5, .5, .1, -.5, -.5, 0, -.5, .5, .1, -.5, -.5, .1, -.5,    // z = 0
                        -.5, 0, .5, .5, 0, .5, .5, .1, .5, -.5, 0, .5, .5, .1, .5, -.5, .1, .5,    // z = 1
                        -.5, 0, -.5, -.5, .1, -.5, -.5, .1, .5, -.5, 0, -.5, -.5, .1, .5, -.5, 0, .5,    // x = 0
                        .5, 0, -.5, .5, .1, -.5, .5, .1, .5, .5, 0, -.5, .5, .1, .5, .5, 0, .5     // x = 1
                    ]
                },
                vnormal: {
                    numComponents: 3, data: [
...
*/
grobjects.push(new Fence("fence1", [-1.4, 0, -7], 4, 8, 4, 4, [1, 1, 0]));//1

grobjects.push(new Fence("fence2", [-0.5, 0, 4.8], 4.5, 4.5, 4, 4.5, [1, 0, 0]));//2

grobjects.push(new Fence("fence3", [4.55, 0, 4.8], 4.5, 4.7, 4, 4.7, [1, 1, 0]));//3

grobjects.push(new Fence("fence4", [5, 0, -2], 4, 5.5, 4, 5, [0, 0, 1]));//4

grobjects.push(new Fence("fence5", [-2.2, 0, 0], 4, 8, 4, 4, [0, 1, 0]));//5
